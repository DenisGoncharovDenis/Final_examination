package com.example.lawyers.config;

import com.example.lawyers.services.PersonDetailsService;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
 ...
 //               .antMatcher("/css/*")
                ...
                .antMatchers("/", "/css/**", "css/**", "/authentication/logout", "/authentication/login", "/authentication/myLogin", "/authentication/registration", "/error", "/product", "/static/img/logomini.png", "/img/*", "/product/info/{id}", "/product/search").permitAll()
...
//        authenticationManagerBuilder.authenticationProvider(authenticationProvider);
    ...
    public void configure(WebSecurity web){
        web.ignoring().antMatchers("/js/**", "/css/**", "css/**", "img/**","/fonts/**", "/resources/**", "/static/**");
    }
}
